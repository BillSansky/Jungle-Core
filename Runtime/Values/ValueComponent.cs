...
namespace Jungle.Values
{
    ...
    [JungleClassInfo("Value Component Base", "Base MonoBehaviour for exposing runtime values.", null, "Core")]
    ...
    /// </summary>
    /// <typeparam name="T">Type of the value provided by the component.</typeparam>
    [JungleClassInfo("Value Component", "MonoBehaviour storing a single runtime value.", null, "Core")]
    ...
    [JungleClassInfo("Value List Component", "MonoBehaviour exposing a list of values.", null, "Core")]
    ...
    /// </summary>
    /// <typeparam name="TElement">Type of the elements contained in the list.</typeparam>
    [JungleClassInfo("Serialized Value List Component", "Value list component backed by a serialized List.", null, "Core")]
