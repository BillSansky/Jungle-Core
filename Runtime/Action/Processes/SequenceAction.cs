...
namespace Jungle.Actions
{
    ...
    public class SequenceAction : IProcessAction
    {
        ...
        public class Step
        {
            ...
            [Header("Step StartProcess Delay")]
        ...
        /// <summary>
        /// Stops the sequence when its owning state is exited.
        /// </summary>
        ...
        private void StartStep(Step s)
        {
            ...
            AttachStepListeners(s); // attach before StartProcess to catch instant-complete

            if (!parallelRunning.Contains(s))
                parallelRunning.Add(s);

            s.Action.StartProcess(s.completedHandler);
        }
