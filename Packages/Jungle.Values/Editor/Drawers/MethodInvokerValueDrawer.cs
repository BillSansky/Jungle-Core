    ...
    public class MethodInvokerValueDrawer : PropertyDrawer
    {
        public override VisualElement CreatePropertyGUI(SerializedProperty property)
        {
            ...
            componentField.schedule.Execute(() =>
            {
                ...
                EditorUtils.SetupFieldWithClassSelectionButton(componentField, typeof(IComponentValue), componentProp, null);
            });
        ...
        private Component ResolveComponent(SerializedProperty componentProp)
        {
            ...
            {
                if (componentProp.managedReferenceValue is IComponentValue reference)
                {
                    return reference.V;
                }
            }
