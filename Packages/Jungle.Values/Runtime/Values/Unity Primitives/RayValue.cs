...
namespace Jungle.Values.UnityTypes
{
    ...
    /// </summary>
    [Serializable]
    [JungleClassInfo("Ray Value", "Stores a ray locally on the owner.", null, "Values/Unity Types", true)]
    ...
    /// </summary>
    [Serializable]
    [JungleClassInfo("Ray From Camera", "Creates a ray from a camera using a screen position.", null, "Values/Unity Types")]
    ...
    /// </summary>
    [Serializable]
    [JungleClassInfo("Ray From Origin And Direction", "Creates a ray using an origin and direction.", null, "Values/Unity Types")]
