...
namespace Jungle.Values.UnityTypes
{
    ...
    [JungleClassInfo("Vector2Int Value Asset", "ScriptableObject storing a 2D integer vector.", null, "Values/Unity Primitives")]
    ...
    [JungleClassInfo("Vector2Int List Asset", "ScriptableObject storing a list of 2D integer vectors.", null, "Values/Unity Primitives")]
    ...
    [Serializable]
    [JungleClassInfo("Vector2Int Value From Asset", "Reads a 2D integer vector from a Vector2IntValueAsset.", null, "Values/Unity Primitives")]
    ...
    [Serializable]
    [JungleClassInfo("Vector2Int List From Asset", "Reads 2D integer vectors from a Vector2IntListValueAsset.", null, "Values/Unity Primitives")]
