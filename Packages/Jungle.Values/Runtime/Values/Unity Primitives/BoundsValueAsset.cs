...
namespace Jungle.Values.UnityTypes
{
    ...
    [JungleClassInfo("Bounds Value Asset", "ScriptableObject storing a Bounds value.", null, "Values/Unity Primitives")]
    ...
    [JungleClassInfo("Bounds List Asset", "ScriptableObject storing a list of Bounds values.", null, "Values/Unity Primitives")]
    ...
    [Serializable]
    [JungleClassInfo("Bounds Value From Asset", "Reads a Bounds value from a BoundsValueAsset.", null, "Values/Unity Primitives")]
    ...
    [Serializable]
    [JungleClassInfo("Bounds List From Asset", "Reads Bounds values from a BoundsListValueAsset.", null, "Values/Unity Primitives")]
