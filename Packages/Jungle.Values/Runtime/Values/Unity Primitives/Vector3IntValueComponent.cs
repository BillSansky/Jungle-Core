...
namespace Jungle.Values.UnityTypes
{
    ...
    /// </summary>
    [JungleClassInfo("Vector3Int Value Component", "Component exposing a 3D integer vector.", null, "Unity Types")]
    ...
    [JungleClassInfo("Vector3Int List Component", "Component exposing a list of 3D integer vectors.", null, "Unity Types")]
    ...
    [Serializable]
    [JungleClassInfo("Vector3Int Value From Component", "Reads a 3D integer vector from a Vector3IntValueComponent.", null, "Unity Types")]
    ...
    [Serializable]
    [JungleClassInfo("Vector3Int List From Component", "Reads 3D integer vectors from a Vector3IntListValueComponent.", null, "Unity Types")]
