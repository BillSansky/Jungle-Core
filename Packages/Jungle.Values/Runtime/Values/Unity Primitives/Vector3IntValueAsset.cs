...
namespace Jungle.Values.UnityTypes
{
    ...
    [JungleClassInfo("Vector3Int Value Asset", "ScriptableObject storing a 3D integer vector.", null, "Values/Unity Primitives")]
    ...
    [JungleClassInfo("Vector3Int List Asset", "ScriptableObject storing a list of 3D integer vectors.", null, "Values/Unity Primitives")]
    ...
    [Serializable]
    [JungleClassInfo("Vector3Int Value From Asset", "Reads a 3D integer vector from a Vector3IntValueAsset.", null, "Values/Unity Primitives")]
    ...
    [Serializable]
    [JungleClassInfo("Vector3Int List From Asset", "Reads 3D integer vectors from a Vector3IntListValueAsset.", null, "Values/Unity Primitives")]
