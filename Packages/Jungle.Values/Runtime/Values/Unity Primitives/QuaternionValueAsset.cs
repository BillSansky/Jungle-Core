...
namespace Jungle.Values.UnityTypes
{
    ...
    [JungleClassInfo("Quaternion Value Asset", "ScriptableObject storing a rotation quaternion.", null, "Values/Unity Primitives")]
    ...
    [JungleClassInfo("Quaternion List Asset", "ScriptableObject storing a list of quaternions.", null, "Values/Unity Primitives")]
    ...
    [Serializable]
    [JungleClassInfo("Quaternion Value From Asset", "Reads a rotation quaternion from a QuaternionValueAsset.", null, "Values/Unity Primitives")]
    ...
    [Serializable]
    [JungleClassInfo("Quaternion List From Asset", "Reads quaternions from a QuaternionListValueAsset.", null, "Values/Unity Primitives")]
