...
namespace Jungle.Values.UnityTypes
{
    ...
    /// </summary>
    [JungleClassInfo("Gradient Value Component", "Component exposing a gradient.", null, "Values/Unity Primitives")]
    ...
    [JungleClassInfo("Gradient List Component", "Component exposing a list of gradients.", null, "Values/Unity Primitives")]
    ...
    [Serializable]
    [JungleClassInfo("Gradient Value From Component", "Reads a gradient from a GradientValueComponent.", null, "Values/Unity Primitives")]
    ...
    [Serializable]
    [JungleClassInfo("Gradient List From Component", "Reads gradients from a GradientListValueComponent.", null, "Values/Unity Primitives")]
