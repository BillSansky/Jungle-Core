...
namespace Jungle.Values.UnityTypes
{
    ...
    [JungleClassInfo("Color32 Value Asset", "ScriptableObject storing a Color32 value.", null, "Values/Unity Primitives")]
    ...
    [JungleClassInfo("Color32 List Asset", "ScriptableObject storing a list of Color32 values.", null, "Values/Unity Primitives")]
    ...
    [Serializable]
    [JungleClassInfo("Color32 Value From Asset", "Reads a Color32 value from a Color32ValueAsset.", null, "Values/Unity Primitives")]
    ...
    [Serializable]
    [JungleClassInfo("Color32 List From Asset", "Reads Color32 values from a Color32ListValueAsset.", null, "Values/Unity Primitives")]
