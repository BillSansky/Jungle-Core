...
namespace Jungle.Values.UnityTypes
{
    ...
    [JungleClassInfo("Vector3 Value Asset", "ScriptableObject storing a 3D vector.", null, "Values/Unity Primitives")]
    ...
    [JungleClassInfo("Vector3 List Asset", "ScriptableObject storing a list of 3D vectors.", null, "Values/Unity Primitives")]
    ...
    [Serializable]
    [JungleClassInfo("Vector3 Value From Asset", "Reads a 3D vector from a Vector3ValueAsset.", null, "Values/Unity Primitives")]
    ...
    [Serializable]
    [JungleClassInfo("Vector3 List From Asset", "Reads 3D vectors from a Vector3ListValueAsset.", null, "Values/Unity Primitives")]
