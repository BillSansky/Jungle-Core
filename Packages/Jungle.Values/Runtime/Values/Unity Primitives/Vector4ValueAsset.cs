...
namespace Jungle.Values.UnityTypes
{
    ...
    [JungleClassInfo("Vector4 Value Asset", "ScriptableObject storing a 4D vector.", null, "Unity Types")]
    ...
    [JungleClassInfo("Vector4 List Asset", "ScriptableObject storing a list of 4D vectors.", null, "Unity Types")]
    ...
    [Serializable]
    [JungleClassInfo("Vector4 Value From Asset", "Reads a 4D vector from a Vector4ValueAsset.", null, "Unity Types")]
    ...
    [Serializable]
    [JungleClassInfo("Vector4 List From Asset", "Reads 4D vectors from a Vector4ListValueAsset.", null, "Unity Types")]
