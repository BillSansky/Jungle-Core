...
namespace Jungle.Values.UnityTypes
{
    ...
    /// </summary>
    [JungleClassInfo("Vector2Int Value Component", "Component exposing a 2D integer vector.", null, "Values/Unity Primitives")]
    ...
    [JungleClassInfo("Vector2Int List Component", "Component exposing a list of 2D integer vectors.", null, "Values/Unity Primitives")]
    ...
    [Serializable]
    [JungleClassInfo("Vector2Int Value From Component", "Reads a 2D integer vector from a Vector2IntValueComponent.", null, "Values/Unity Primitives")]
    ...
    [Serializable]
    [JungleClassInfo("Vector2Int List From Component", "Reads 2D integer vectors from a Vector2IntListValueComponent.", null, "Values/Unity Primitives")]
