...
namespace Jungle.Values.UnityTypes
{
    ...
    [JungleClassInfo("Color Value Asset", "ScriptableObject storing a Color value.", null, "Values/Unity Primitives")]
    ...
    [JungleClassInfo("Color List Asset", "ScriptableObject storing a list of colors.", null, "Values/Unity Primitives")]
    ...
    [Serializable]
    [JungleClassInfo("Color Value From Asset", "Reads a Color value from a ColorValueAsset.", null, "Values/Unity Primitives")]
    public class ColorValueFromAsset : ValueFromAsset<Color, ColorValueAsset>, ISettableColorValue
    {
    }
    /// <summary>
    ...
    [Serializable]
    [JungleClassInfo("Color List From Asset", "Reads colors from a ColorListValueAsset.", null, "Values/Unity Primitives")]
