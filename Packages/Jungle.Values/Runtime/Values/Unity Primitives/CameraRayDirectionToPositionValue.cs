...
namespace Jungle.Values.UnityTypes
{
    ...
    /// </summary>
    [Serializable]
    [JungleClassInfo("Camera Ray Direction To Position", "Computes a normalized direction vector from a camera to a world position.", null, "Values/Unity Primitives")]
