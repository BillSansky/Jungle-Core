...
namespace Jungle.Values.GameDev
{
    ...
    /// </summary>
    [Serializable]
    [JungleClassInfo("Component Lookup Value", "Retrieves a Component from a GameObject using a lookup strategy (on object, in children, or in parent).", null, "Values/Game Dev")]
