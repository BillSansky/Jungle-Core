...
namespace Jungle.Values.GameDev
{
    ...
    /// </summary>
    [JungleClassInfo("GameObject Value Component", "Component exposing a GameObject reference.", null, "Game Dev")]
    ...
    [JungleClassInfo("GameObject List Component", "Component exposing a list of GameObjects.", null, "Game Dev")]
    ...
    [Serializable]
    [JungleClassInfo("GameObject Value From Component", "Reads a GameObject reference from a GameObjectValueComponent.", null, "Game Dev")]
    ...
    [Serializable]
    [JungleClassInfo("GameObject List From Component", "Reads GameObjects from a GameObjectListValueComponent.", null, "Game Dev")]
