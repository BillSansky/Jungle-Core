...
namespace Jungle.Values.GameDev
{
    ...
    /// </summary>
    [Serializable]
    [JungleClassInfo("Transform Lookup Value", "Retrieves a Transform component from a GameObject using a lookup strategy (on object, in children, or in parent).", null, "Values/Game Dev")]
