...
namespace Jungle.Values.GameDev
{
    ...
    /// </summary>
    [Serializable]
    [JungleClassInfo("Rigidbody Lookup Value", "Retrieves a Rigidbody component from a GameObject using a lookup strategy (on object, in children, or in parent).", null, "Values/Game Dev")]
