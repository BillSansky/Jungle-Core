...
namespace Jungle.Values.GameDev
{
    ...
    /// </summary>
    [Serializable]
    [JungleClassInfo("Renderer Lookup Value", "Retrieves a Renderer component from a GameObject using a lookup strategy (on object, in children, or in parent).", null, "Values/Game Dev")]
