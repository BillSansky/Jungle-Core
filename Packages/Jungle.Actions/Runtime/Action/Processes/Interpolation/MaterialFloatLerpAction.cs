...
namespace Jungle.Actions
{
    ...
    public class MaterialFloatLerpAction : LerpProcessAction<float>, IImmediateAction
    {
        ...
        protected override void OnInterrupted()
        {
            ...
            foreach (var renderer in targetRenderer.Values)
            {
                if (renderer && originalValuesMap.TryGetValue(renderer, out var originalValues))
                {
                    var materials = renderer.materials;
